...
DEPLOY_ENV=prod
DEPLOY_HOST=tredf-jorgec.tangrama.com.br
DEPLOY_PORT=22
DEPLOY_USER=plone
...
You need either a Ubuntu or Debian based system for tredf-jorgec.tangrama.com.br, enable SSH, and install a supported version of Python 3 on that system.
...
cluster:
  hosts:
    tredf-jorgec.tangrama.com.br:
      ansible_user: root
      ansible_host: tredf-jorgec.tangrama.com.br
      host: tredf-jorgec
      hostname: tredf-jorgec.tangrama.com.br
      swarm_node:
        labels:
          type: manager
          env: production
...
Deploy the stack defined in `devops/stacks/tredf-jorgec.tangrama.com.br.yml` to the remote server with:
