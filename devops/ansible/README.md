...
DEPLOY_ENV=prod
DEPLOY_HOST=tredf-jorgecalasans.tangrama.com.br
DEPLOY_PORT=22
DEPLOY_USER=plone
...
You need either a Ubuntu or Debian based system for tredf-jorgecalasans.tangrama.com.br, enable SSH, and install a supported version of Python 3 on that system.
...
cluster:
  hosts:
    tredf-jorgecalasans.tangrama.com.br:
      ansible_user: root
      ansible_host: tredf-jorgecalasans.tangrama.com.br
      host: tredf-jorgecalasans
      hostname: tredf-jorgecalasans.tangrama.com.br
      swarm_node:
        labels:
          type: manager
          env: production
...
Deploy the stack defined in `devops/stacks/tredf-jorgecalasans.tangrama.com.br.yml` to the remote server with:
