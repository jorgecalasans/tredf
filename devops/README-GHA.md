...
6. Name the environment `tredf-jorgec.tangrama.com.br` and hit `Configure environment`.
...
|-------------|--------------|-------------|
| DEPLOY_HOST | tredf-jorgec.tangrama.com.br | The hostname or IP address of your Docker Swarm manager. |
...
| Name     | Value |
|----------|-------|
| LIVE_ENV | tredf-jorgec.tangrama.com.br |
...
1. Navigate to [Manual Deployment of tredf-jorgec.tangrama.com.br](https://github.com/jorgecalasans/tredf/actions/workflows/manual-deploy.yml).
...
- Initiate a new deployment using the `devops/stacks/tredf-jorgec.tangrama.com.br.yml` stack.
