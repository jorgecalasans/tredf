...
2. Go to your repository at [jorgecalasans/tredf](https://github.com/jorgecalasans/tredf).
3. Click on `Settings` at the top-right corner.
4. In the left sidebar, click on `Environments`.
5. Press `New environment`.
6. Name the environment `tredf-jorgecalasans.tangrama.com.br` and hit `Configure environment`.
...
|-------------|--------------|-------------|
| DEPLOY_HOST | tredf-jorgecalasans.tangrama.com.br | The hostname or IP address of your Docker Swarm manager. |
...
| Name     | Value |
|----------|-------|
| LIVE_ENV | tredf-jorgecalasans.tangrama.com.br |
...
- [CI Workflow](https://github.com/jorgecalasans/tredf/actions/workflows/main.yml)

Upon successful completion of the tests, Docker images for the Backend (`ghcr.io/jorgecalasans/tredf-backend`) and Frontend (`ghcr.io/jorgecalasans/tredf-frontend`) should be available.

### Initiating Manual Deployment

1. Navigate to [Manual Deployment of tredf-jorgecalasans.tangrama.com.br](https://github.com/jorgecalasans/tredf/actions/workflows/manual-deploy.yml).
...
- Initiate a new deployment using the `devops/stacks/tredf-jorgecalasans.tangrama.com.br.yml` stack.
